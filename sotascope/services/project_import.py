...
from sotascope.models.library import Venue, VenueAlias, Work, WorkNote, WorkPDF
...
from sotascope.schemas.project_import import (
    AmbiguousMatch,
    AmbiguousMatchWork,
    ImportResult,
    PendingVenueAlias,
)
from sotascope.services.enrichment import (
...
def import_project(
    ...
    if not isinstance(fmt, int) or fmt > 2:
        raise ValueError(
            ...
            "(max supported: 2). Please upgrade SotAScope."
        )
...
def resolve_import(
    ...
    if action == "merge":
        ...
        from sotascope.services.project_merge import execute_merge
