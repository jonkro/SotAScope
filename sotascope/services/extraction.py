...
from sotascope.external.llm_client import LLMClient
...
def run_extraction_for_work(
    ...
    Args:
        ...
        work_id: ID of the :class:`~sotascope.models.library.Work` to process.
        schema_id: ID of the :class:`ExtractionSchema` to apply.
        llm_client: Configured :class:`~sotascope.external.llm_client.LLMClient`.
