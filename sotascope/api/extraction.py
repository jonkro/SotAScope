...
from sotascope.external.llm_client import make_llm_client
from sotascope.models.extraction import ExtractionColumn, ExtractionSchema
from sotascope.schemas.extraction import (
...
def get_extraction_results(
    ...
    """
    from sotascope.models.library import WorkNote
    from sqlalchemy import select
...
def _run_and_format(
    ...
    from sotascope.services.extraction import run_extraction_for_work
...
def _extraction_bg(
    ...
    :func:`sotascope.database.SessionLocal` and closes it in a ``finally`` block.
    """
...
def export_schema(
    ...
    from sotascope.models.library import Work, WorkNote
    from sotascope.services.extraction import _truncate_note_type
    from sotascope.services.extraction_export import export_as_csv, export_as_latex
...
def preview_extraction_prompt(
    ...
    from sotascope.services.extraction import assemble_extraction_prompt
