...
from sotascope.models.library import Citation, Venue, VenueAlias, Work, WorkAuthor, WorkLocation
from sotascope.models.project import Project, ProjectIgnoredWork, ProjectVenueTier, TopicList, TopicListWork
from sotascope.schemas.projects import (
    ProjectCreate,
    ProjectDetail,
...
from sotascope.schemas.project_merge import MergeDecisions, MergePreview
from sotascope.schemas.project_import import ImportResult, ImportResolveRequest, ResolveAliasesRequest
...
def _auto_enrich_bg(work_id: int) -> None:
    ...
    from sotascope.api.enrichment import _get_client, _get_crossref_client
...
def get_merge_preview(
    ...
    from sotascope.services.project_merge import merge_preview as _preview
...
def merge_project(
    ...
    from sotascope.services.project_merge import execute_merge as _merge
...
def export_project_bibtex(
    ...
    """
    from sotascope.services.bibtex_export import works_to_bibtex
...
async def import_project_zip(
    ...
    """
    from sotascope.services.project_import import import_project as _import
...
def resolve_import_collision(
    ...
    """
    from sotascope.services.project_import import resolve_import as _resolve
