...
from sotascope.models.project import ProjectIgnoredWork, TopicListWork
from sotascope.schemas.works import (
    AuthorCreate,
    AuthorOut,
    BibtexImportRequest,
    BibtexImportResult,
...
from sotascope.schemas.notes import WorkNoteCreate, WorkNoteOut, WorkNoteUpdate
...
def _register_and_extract_pdf(
    ...
    """
    from sotascope.services.pdf import ExtractionError, extract_pdf_text
...
def fetch_pdf_oa(work_id: int, db: Session = Depends(get_db)):
    ...
    from sotascope.api.enrichment import _get_contact_email, _get_ssl_verify
    from sotascope.external.pdf_fetch import PDFFetchError, fetch_pdf_for_work
